                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <div class="form-label">
                                            <label class="form-label required fs-5 fw-bold mb-2">Property's Landlord</label>
                                                <select class="form-select form-select-solid @error('landlord') is-invalid @enderror" wire:model="landlord" >Property Type
                                                    <option value="default">Select Property's Landlord</option>
                                                    @foreach ($landlords as $landlord)
                                                        <option value="{{ $landlord->id}}">{{ $landlord->fname.' '.$landlord->lname }}</option>
                                                    @endforeach
                                                </select>
                                            @error('landlord')<p class="text-danger">{{ $message }}</p> @enderror
                                        </div>
                                    </div>
                                </div>
