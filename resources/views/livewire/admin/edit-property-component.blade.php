        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <form class="form" id="kt_modal_add_customer_form" wire:submit.prevent="updateProperty">
                        <div class="modal-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <a class="text-white" href="{{ route('admin.properties') }}">
                                        <button type="button" class="btn btn-primary">All Properties</button>
                                    </a>
                                </div>
                                <!--end::Toolbar-->
                            </div>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-bold mb-2">Property Price</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid @error('price') is-invalid @enderror" wire:model="price"
                                        placeholder="Property Price" name="price" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="input-file" wire:model="newimage"/>
                                                ...
                                                @else
                                                <img src="{{ asset('files/assets/real') }}/{{ $image }}" width="120">
                                                @endif
                        ...
                        <div class="modal-footer flex-center">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">Update Property</span>
                            </button>
                            <!--end::Button-->
                        </div>
                    </form>
