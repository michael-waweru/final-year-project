        ...
        <div class="container">
            ...
            <div class="card col-12">
                <div class="section-block p-10">
                    <h3 class="section-title text-capitalize">Add Property Type
                        ...
                        <form wire:submit.prevent="storeType">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="name" type="text" placeholder="e.g. 2 Bedrooms, Bungallow" class="form-control @error('name') is-invalid @enderror"
