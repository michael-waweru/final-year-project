    ...
    <div class="col-12">
        ...
        <div class="simple-card">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <a href="{{ route('landlord.property.add') }}">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{ route('landlord.property.edit',['property_slug'=>$property->slug]) }}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
        ...
        function deleteConfirmation(id) {
            swal.fire({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ url('/landlord/property/delete')}}/" + id,
