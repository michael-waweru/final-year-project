                ...
                <div class="card-body pt-9 pb-0">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3">Verified Landlord</span>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Info-->
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="{{ route('landlord.account') }}">Overview</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="{{ route('landlord.change-password') }}">Account Settings</a>
                            </li>
                        </ul>
                    </div>
                </div>
