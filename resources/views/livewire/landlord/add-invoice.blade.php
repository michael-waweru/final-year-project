                ...
                <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-12">
                            <!--begin::Form-->
                            <form action="{{ route('landlord.invoice.store') }}" method="post">
                            @csrf
                            <!--begin::Wrapper-->
                                ...
                                <div class="row gx-10 mb-5">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-5">
                                            <input value="{{ Auth::user()->fname.' '.Auth::user()->lname }}" name="entry_id" type="text" class="form-control form-control-solid" disabled/>
                                        </div>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                ...
                                <!--begin::Notes-->
                                <div class="mb-0">
                                    <label class="form-label fs-6 fw-bolder text-gray-700">Invoice Notes</label>
